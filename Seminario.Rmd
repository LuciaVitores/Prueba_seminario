...
Para ello relacionamos las dos tablas con las que queremos trabajar, PIB2 y nuevaNatalidad (tabla creada anteriormente que almacena la información relacionada con la media total del nacimiento en cada comunidad).
