...
```{r}
ggplot(data=nuevaNatalidad, aes(x=reorder(`Comunidades autónomas`, nat_prom ), y=nat_prom, fill=`Comunidades autónomas`)) + theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
    geom_bar(stat="identity", position="dodge")
```
